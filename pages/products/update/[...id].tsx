...
// import ViewProduct from "@/components/ViewProductImages"
// import { Product, PropertyType, CategoryType, CatProperty } from "@/config/config"
// import { destructDescriptionArray, constructDescriptionArray } from "@/components/functions"
...
//     const [categories, setCategories] = useState<CategoryType[]>([])
//     const [categoryProperties, setCategoryProperties] = useState<CatProperty[]>([])
//     const [allCatProps, setAllCatProps] = useState({})
...
//                 setImages(destructDescriptionArray(responseData.images))
//                 setCategory(responseData.category._id)
//                 // setAllCatProps(responseData.categoryProperties)
//             }
//             else {
//                 toast('failed to fetch data')
//             }
...
//     const changePropertyValues = (value: string, name: string, catName: string) => {  
//         setCategoryProperties(prev => [
//             ...prev,
//             {
//                 catName,
...
//     useEffect(() => {
//         setAllCatProps((prev: any) => {
//             categoryProperties?.map((cat: CatProperty) => {
//                 const newCategory = categories.find(c => c._id === category)
//                 if(newCategory?.name !== cat.catName) {
//                     prev = {}
//                 }
//                 else {
//                     const key = cat.properties.name!
//                     const value = cat.properties.value!
//                     prev = { ...prev, [key]: value}
//                 }
//             })
//             console.log("prevObj: ", {...prev})     
...
//                 </select>
//                 {
//                     properties?.properties.map(({name, values}, index) => (
//                         <div key={index} className="flex justify-between gap-2">
//                         {
//                             <>
...
//                                     className="w-4/5" 
//                                     onChange={e => changePropertyValues(
//                                         e.target.value, name, properties.catName
//                                     )}
//                                     value={
//                                         allCatProps[name as keyof typeof allCatProps] 
//                                         || productAttribute.categoryProperties[name as keyof typeof productAttribute.categoryProperties]
//                                     }
//                                 >
//                                     <option value={""}>--Select--</option>
//                                     {
